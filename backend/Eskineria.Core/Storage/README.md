# Eskineria Storage Module

Bu dokuman, `Eskineria.Core/Storage` modulu icin teknik referans niteligindedir. Amac, depolama katmaninin nasil calistigini, nasil konfigure edildigini ve uygulama katmaninda nasil kullanildigini tek yerde netlestirmektir.
...
- `Eskineria.Application/ServiceCollectionExtensions.cs` icinde `services.AddEskineriaStorage(...)` cagrilir.
