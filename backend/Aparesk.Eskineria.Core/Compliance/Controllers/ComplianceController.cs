...
namespace Aparesk.Eskineria.Core.Compliance.Controllers;
...
public class ComplianceController : ApiControllerBase
{
    ...
    [ProducesResponseType(typeof(Aparesk.Eskineria.Core.Shared.Response.Response), StatusCodes.Status400BadRequest)]
    ...
    [HttpPut("terms/{id}")]
    [HasPermission("Compliance", "Manage")]
    [ProducesResponseType(typeof(Aparesk.Eskineria.Core.Shared.Response.Response), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(Aparesk.Eskineria.Core.Shared.Response.Response), StatusCodes.Status404NotFound)]
    ...
    [Authorize]
    [HttpPost("accept")]
    [ProducesResponseType(typeof(Aparesk.Eskineria.Core.Shared.Response.Response), StatusCodes.Status201Created)]
    [ProducesResponseType(typeof(Aparesk.Eskineria.Core.Shared.Response.Response), StatusCodes.Status400BadRequest)]
    public async Task<IActionResult> AcceptTerms([FromBody] AcceptTermsDto dto)
    {
        if (!TryGetCurrentUserId(out var userId))
        {
            return Unauthorized(Aparesk.Eskineria.Core.Shared.Response.Response.Fail(_localizer[LocalizationKeys.UserNotFound], StatusCodes.Status401Unauthorized));
        }
