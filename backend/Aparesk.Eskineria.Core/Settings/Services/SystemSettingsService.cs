...
public class SystemSettingsService : ISystemSettingsService
{
    ...
    private const string DefaultApplicationName = "Aparesk.Eskineria Backend";
    ...
    private static readonly IReadOnlyDictionary<string, string> AuthSettingDefaults =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [SystemSettingKeys.SystemEmailSenderName] = "Aparesk.Eskineria",
    ...
    public async Task<DataResponse<AuthSystemSettingsDto>> GetAuthSettingsAsync()
    {
        ...
        var dto = new AuthSystemSettingsDto
        {
            ...
            EmailSenderName = NormalizeTextSetting(
                GetStringSettingValue(settingsMap, SystemSettingKeys.SystemEmailSenderName, "Aparesk.Eskineria"),
                200),
