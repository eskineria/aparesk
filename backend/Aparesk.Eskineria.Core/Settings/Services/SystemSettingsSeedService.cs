...
namespace Aparesk.Eskineria.Core.Settings.Services;
...
public sealed class SystemSettingsSeedService
{
    ...
    public async Task SeedStartupAsync(IConfiguration configuration)
    {
        var settingsToSeed = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [SystemSettingKeys.AuthMfaEnabled] = (configuration.GetValue<bool?>("StartupSeed:SystemSettings:Auth:MfaEnabled") ?? true).ToString().ToLowerInvariant(),
            [SystemSettingKeys.AuthMfaEnforcedForAll] = (configuration.GetValue<bool?>("StartupSeed:SystemSettings:Auth:MfaEnforcedForAll") ?? false).ToString().ToLowerInvariant(),
            ...
            [SystemSettingKeys.SystemBrandingApplicationName] = configuration.GetValue<string?>("StartupSeed:SystemSettings:Branding:ApplicationName") ?? "Aparesk.Eskineria Backend",
            [SystemSettingKeys.SystemEmailSenderName] = configuration.GetValue<string?>("StartupSeed:SystemSettings:System:EmailSenderName") ?? "Aparesk.Eskineria",
            ...
            [SystemSettingKeys.SystemLocalizationDefaultCulture] = configuration.GetValue<string?>("StartupSeed:SystemSettings:System:LocalizationDefaultCulture") ?? "tr-TR",
            [SystemSettingKeys.SystemLocalizationFallbackCulture] = configuration.GetValue<string?>("StartupSeed:SystemSettings:System:LocalizationFallbackCulture") ?? "tr-TR",
