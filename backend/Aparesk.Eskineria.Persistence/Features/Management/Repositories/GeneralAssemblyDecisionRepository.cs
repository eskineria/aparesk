...
public sealed class GeneralAssemblyDecisionRepository : EfRepository<DbContext, GeneralAssemblyDecision>, IGeneralAssemblyDecisionRepository
{
    public GeneralAssemblyDecisionRepository(ApplicationDbContext dbContext, RepositoryOptions options)
