...
public sealed class SiteBlockRepository : EfRepository<DbContext, SiteBlock>, ISiteBlockRepository
{
    public SiteBlockRepository(ApplicationDbContext dbContext, RepositoryOptions options)
