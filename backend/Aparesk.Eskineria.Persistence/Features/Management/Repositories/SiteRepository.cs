...
public sealed class SiteRepository : EfRepository<DbContext, Site>, ISiteRepository
{
    public SiteRepository(ApplicationDbContext dbContext, RepositoryOptions options)
