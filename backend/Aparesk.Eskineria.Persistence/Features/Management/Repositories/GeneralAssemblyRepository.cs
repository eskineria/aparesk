...
public sealed class GeneralAssemblyRepository : EfRepository<DbContext, GeneralAssembly>, IGeneralAssemblyRepository
{
    public GeneralAssemblyRepository(ApplicationDbContext dbContext, RepositoryOptions options)
