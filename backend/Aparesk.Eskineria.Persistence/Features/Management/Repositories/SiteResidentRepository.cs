...
public sealed class SiteResidentRepository : EfRepository<DbContext, SiteResident>, ISiteResidentRepository
{
    public SiteResidentRepository(ApplicationDbContext dbContext, RepositoryOptions options)
